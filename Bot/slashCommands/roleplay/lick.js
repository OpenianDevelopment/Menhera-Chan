...
module.exports = {
    ...
    run: async (client, args, guild) => {
        ...
        const rtxt = [
            `**Woah ${author.username} licked ${member.user.username}**`,
            `**${author.username} *licks* ${member.user.username} lick lick lick**`,
            `**${member.user.username} is being licked by ${author.username}**`
        ];
