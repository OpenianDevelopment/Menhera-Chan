...
module.exports = {
    ...
    run: async(client,args,guild)=>{
        ...
        const rtxt = [ 
            `**${author.username} pats ${member.user.username}**`,
            `**${author.username} feels sorry for ${member.user.username} so they pat them**`,
            `**${member.user.username} died from extreme cuteness of ${author.username}**`
        ];
